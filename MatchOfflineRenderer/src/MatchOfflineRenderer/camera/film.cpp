...
namespace MatchOfflineRenderer::camera {
    static constexpr size_t swatch_reflectance_sample_count = 72;
    spectra::PiecewiseLinearSpectrum PixelSensor::swatch_reflectances[PixelSensor::swatch_reflectance_count] = {
        spectra::convert_from_interleaved_data(
            std::array {
